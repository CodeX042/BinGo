...
import { persistor } from "../store/store"; // Import persistor from your store
...
export const logoutUser = async (dispatch) => {
  try {
    ...
    await storage.removeItem("persist:auth"); // Replace 'auth' with the key used for auth slice
    await storage.removeItem("persist:trash"); // Replace 'auth' with the key used for trash slice
